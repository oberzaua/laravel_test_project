  ...
  <div class="h-screen tracking-normal flex flex-col">
    <nav id="header" class="sticky z-10 top-0 flex-none">
      ...
      <div class="lg:max-w-4xl mx-auto px-4 flex flex-nowrap items-center justify-between mt-0 py-3">
        ...
        <div class="lg:items-center lg:w-auto flex mt-2 lg:mt-0 bg-gray-100 md:bg-transparent z-20" id="nav-content">
    ...
    <div class="container w-full md:max-w-3xl mx-auto py-6 flex-grow">
      <div class="w-full px-4 md:px-6 text text-gray-800 leading-normal" style="font-family:Georgia,serif;">
        ...
        ?>
          <h4 class="font-bold font-sans break-normal text-gray-900 pt-6 pb-2 text-3xl md:text-2xl"><?php
    ...
    ">
            <h3 class="flex flex-1 pl-4 py-3 font-semibold md:text-xl pt-3">
              <svg class="w-7 h-7 mr-2 shrink-0" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="flex w-full md:w-1/2">
              <div class="">
                <p class="text-gray-600 text-sm text-left">
                  ...
                  More information can be found in <a class="inline-block text-green-600 no-underline hover:text-green-900 hover:text-underline" href="https://www.jetbrains.com/help/phpstorm/validating-the-configuration-of-the-debugging-engine.html">PhpStorm
            ...
            <div class="flex justify-end w-full md:w-1/2">
              <div class="">
                <ul class="list-reset text-sm">
                  <li>
                    <a class="inline-block text-gray-600 no-underline hover:text-gray-900 hover:text-underline py-1" href="https://github.com/JetBrains/phpstorm-xdebug-validation">GitHub</a>
                  </li>
                  <li>
                    <a class="inline-block text-gray-600 no-underline hover:text-gray-900 hover:text-underline py-1" href="https://www.jetbrains.com/help/phpstorm/validating-the-configuration-of-the-debugging-engine.html">PhpStorm
                      Documentation</a>
                  </li>
                  <li>
                    <a class="inline-block text-gray-600 no-underline hover:text-gray-900 hover:text-underline py-1" href="https://xdebug.org/docs/">Xdebug Documentation</a>
                  </li>
                </ul>
              </div>
            </div>
